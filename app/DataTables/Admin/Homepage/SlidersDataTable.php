...
namespace App\DataTables\Admin\Homepage;
...
class SlidersDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (auth()->user()->can('admin.homepage.sliders.create')) {
        ...
        if (auth()->user()->can('admin.homepage.sliders.export')) {
        ...
        if (auth()->user()->can('admin.homepage.sliders.destroy')) {
