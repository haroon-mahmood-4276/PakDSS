(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="fa-solid fa-file-excel"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fa-solid fa-file-excel"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa-solid fa-rotate-left"></i> ' + dt.i18n('buttons.reset', 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="fa-solid fa-rotate"></i> ' + dt.i18n('buttons.reload', 'Reload');
        },
