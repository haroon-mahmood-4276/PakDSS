...
! function () {
    ...
    const Yn = (e, t, n) => {
        ...
        Eo = (e, t, n, o) => ((e, t, n, o, r) => {
            ...
            return e.dom.addEventListener(t, s, !1), {
                unbind: O(So, e, t, s, !1)
            }
        })(e, t, n, o),
        So = (e, t, n, o) => {
    ...
    const Uo = e => t => !!t && t.nodeType === e,
        ...
        us = e => jo(e) && "all" === e.getAttribute("data-mce-bogus"),
        ms = (e, t = !0) => ((e, t) => {
            let n = 0;
            if (ls(e, e)) return !1; {
                let o = e.firstChild;
            ...
            const d = {
                parse: t => {
                    ...
                    if (t) {
                        ...
                        u("border", "", !0), u("border", "-width"), u("border", "-color"), u("border", "-style"), u("padding", ""), u("margin", ""), y = "border-style", C = "border-color", m(v = "border-width") && m(y) && m(C) && (a.border = a[v] + " " + a[y] + " " + a[C], delete a[v], delete a[y], delete a[C]), "medium none" === a.border && delete a.border, "none" === a["border-image"] && delete a["border-image"]
                    }
                    var v, y, C;
                    return a
                },
    ...
    const Dy = (e, t, n, o) => {
        ...
        RC = e => !(!e || !e.ownerDocument) && kn(bn(e.ownerDocument), bn(e)),
        AC = (e, t, n, o) => {
            let r, s;
            const {
    ...
    const uS = (e, t, n) => e.stype === cS.Error ? t(e.serror) : n(e.svalue),
        ...
        kS = e => ({
            extract: (t, n) => {
                return r = e => ((e, t) => hS(e, N(t)))(t, e), (o = e(n)).stype === cS.Error ? r(o.serror) : o;
                var o, r
            },
            toString: N("val")
        }),
        ...
        i_ = NS([YS, zS("trigger"), qS("minChars", 1), ((e, t) => IS(e, e, CS(1), TS()))("columns"), qS("maxResults", 10), HS("matches", MS), XS, QS, (l_ = PS, VS("highlightOn", [], RS(l_)))]);
    var l_;
                ...
                const s = Math.max(0, n.startOffset),
                    ...
                    l = ((e, t, n, o) => {
                        ...
                        return ((e, t) => {
                            ...
                            pattern: e,
                            range: MR(s, s.getRoot(), t, 0, t, 0, !0)
                        }]).getOr([])
                    })(e, o, a);
    ...
    function () {
        ...
        var f, l, s = n("object"),
            ...
            A = function (n) {
                return d(n) || "" === n ? [] : (n = p(n) ? e(n, (function (n) {
                    return n.split(/[\s+,]/)
                })) : n.split(/[\s+,]/), e(n, (function (n) {
        ...
        function P(e, i) {
            return function (n) {
                var t = A(n.plugins),
                    r, r = 0 < (r = V(i)).length ? t.concat(r) : t;
        ...
        var L = function (n) {
                return (n = /([0-9]+)\.([0-9]+)\.([0-9]+)(?:(\-.+)?)/.exec(n)) ? S(O(n[1]), O(n[2]), O(n[3])) : S(0, 0, 0)
            },
            q = function (n, t) {
                var r = R(n.major, t.major);
                return 0 !== r ? r : 0 !== (r = R(n.minor, t.minor)) ? r : 0 !== (r = R(n.patch, t.patch)) ? r : 0
            },
            N = function (n) {
                return L([n.majorVersion, n.minorVersion].join(".").split(".").slice(0, 3).join("."))
            },
            V = function (n) {
                return (n = o(n).forced_plugins) || []
            },
            k = t((function (n) {
                return I(n, "4.7.0")
            }), (function (n) {
            ...
            $ = t((function (n) {
                ...
                n.overrideDefaults = (e = r, function (n) {
                    var t = e.util.URI,
                        r, r;
                    (r = ((r = n.base_url) && (this.baseURL = new t(this.documentBaseURL).toAbsolute(r.replace(/\/+$/, "")), this.baseURI = new t(this.baseURL)), n.suffix)) && (this.suffix = r), this.defaultSettings = n
    ...
    tinymce.baseURL = window.location.origin + "/seller-assets/vendors/tinymce",
    function () {
        "use strict";
            ...
            R = function (s, u) {
                return {
                    send: function (t, e, n) {
                        ...
                        i.src = s.chiffer_snowplow_service_url + r, i.onload = o(!0), i.onerror = o(!1)
                    }
                }
            },
            T = function (e) {
        ...
        c = {
            ...
            return t = t.api_key, i(t) ? t : void 0
        }(t = null != (t = tinymce.defaultOptions) ? t : tinymce.defaultSettings)) ? c : ((r = function (t, e) {
            return t = R(t, e), T(t)
            ...
            load: function (n) {
                n.once("init", (function () {
                    ...
                    e(t = t.source) && r.sendStat("powerpaste_".concat(t))
