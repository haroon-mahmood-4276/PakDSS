...
! function () {
    ...
    const n = ("allow_html_in_named_anchor",
            ...
            r ? ((e, t, o) => {
                    ...
                    e.undoManager.transact((() => {
                        n(e) || e.selection.collapse(!0),
                            e.selection.isCollapsed() ? e.insertContent(e.dom.createHTML("a", {
                                id: a
                            })) : ((e => {
                                    const n = e.dom;
    ...
    e.add("anchor", (e => {
        (e => {
            (0,
                e.options.register)("allow_html_in_named_anchor", {
                processor: "boolean",
                default: !1
            })
        })(e),
            ...
            e.addCommand("mceAnchor", (() => {
                (e => {
                    ...
                    e.windowManager.open({
                        ...
                        onSubmit: t => {
                            ((e, t) => /^[A-Za-z][A-Za-z0-9\-:._]*$/.test(t) ? (d(e, t),
                                !0) : (e.windowManager.alert("ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores."),
