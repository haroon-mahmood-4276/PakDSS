            ...
            N = function () {
                function t(e) {
                    ...
                    if (function (t, e) {
                        ...
                        if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === o || o, this.settings.controls = n || b, this.settings.defaultTextDir = "rtl" === l || z, this.settings.defaultLayoutType = r || T, this.settings.defaultMenuCollapsed = void 0 !== c ? c : F, this.settings.defaultMenuFlipped = void 0 !== u ? u : k, this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : void 0, this.settings.defaultNavbarFixed = void 0 !== h ? h : C, this.settings.defaultFooterFixed = void 0 !== p ? p : A, this.settings.availableThemes = f || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== g ? g : w), this.settings.styles = m || _, this.settings.defaultStyle = y || S, this.settings.lang = N || "en", this.pathResolver = v || function (t) {
                                return t
                            }, this.settings.styles.length < 2) {
                            var E = this.settings.controls.indexOf("style"); - 1 !== E && (this.settings.controls = this.settings.controls.slice(0, E).concat(this.settings.controls.slice(E + 1)))
                        }
                ...
                return e = t, s = [{
                    ...
                    value: function () {
                        if (this._hasControls("style")) {
                            ...
                            this._insertStylesheet("template-customizer-core-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "core.min".concat("light" !== t ? "-".concat(t) : "")))), ("light" === t ? ["dark-style"] : ["light-style"]).forEach((function (t) {
