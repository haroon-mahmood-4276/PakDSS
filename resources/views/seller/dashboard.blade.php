                            ...
                            <div class="new-member-list">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center"><img class="avatar"
                                            src="{{ asset('vendor-assets') }}/imgs/people/avatar4.jpg" alt="">
                                        <div>
                                            <h6>Patric Adams</h6>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center"><img class="avatar"
                                            src="{{ asset('vendor-assets') }}/imgs/people/avatar2.jpg" alt="">
                                        <div>
                                            <h6>Dilan Specter</h6>
                                            <p class="text-muted font-xs">Sanfrancisco</p>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center"><img class="avatar"
                                            src="{{ asset('vendor-assets') }}/imgs/people/avatar3.jpg" alt="">
                                        <div>
                                            <h6>Tomas Baker</h6>
                                            <p class="text-muted font-xs">Sanfrancisco</p>
                                        </div>
                            ...
                            <ul class="verti-timeline list-unstyled font-sm">
                                <li class="event-list">
                                    <div class="event-timeline-dot"><i
                                            class="material-icons md-play_circle_outline font-xxl"></i>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
