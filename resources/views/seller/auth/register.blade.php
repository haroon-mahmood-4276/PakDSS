...
@section('page-title', 'Become a seller')
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
        <div class="authentication-inner row">
            ...
            <div
                ...
                <img src="{{ asset('admin-assets') }}/img/illustrations/auth-register-multisteps-illustration.png"
                    alt="auth-register-multisteps" class="img-fluid" width="280">

                <img src="{{ asset('admin-assets') }}/img/illustrations/bg-shape-image-light.png" alt="auth-register-multisteps"
