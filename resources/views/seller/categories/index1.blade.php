        ...
        <div class="card-body">
            <div class="row gx-3">
                ...
                @forelse ($categories as $category)
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6 h-100">
                        <figure class="card border-1">
                            ...
                            <figcaption class="card-body text-center">
                                ...
                                <a href="#"> 0 products</a> | {{ $category->brands_count }} brands
                            </figcaption>
                        </figure>
                    </div>
                @empty
                ...
                {{ $categories->onEachSide(2)->links('seller.layout.pagination.bootstrap-5') }}
