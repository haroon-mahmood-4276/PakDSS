                                        ...
                                        <li class="menu-item">
                                            ...
                                            <ul class="menu-sub">
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-sub">
                                                        <li class="menu-item">
                                                            <a href="extended-ui-timeline-basic.html"
                                                                class="menu-link">
                                                                <div data-i18n="Basic">Basic</div>
                                                            </a>
                                                        </li>
                                    ...
                                    <div class="card-body">
                                        <ul class="p-0 m-0">
                                            <li class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/us.svg"
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/br.svg"
                                                    alt="User" class="rounded-circle me-3" width="34" />
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/in.svg"
                                                    alt="User" class="rounded-circle me-3" width="34" />
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/au.svg"
                                                    alt="User" class="rounded-circle me-3" width="34" />
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/fr.svg"
                                                    alt="User" class="rounded-circle me-3" width="34" />
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <img src="{{ asset('admin-assets') }}/svg/flags/cn.svg"
                                                    alt="User" class="rounded-circle me-3" width="34" />
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
