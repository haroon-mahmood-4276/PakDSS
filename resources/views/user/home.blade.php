                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="banner-big bg-11"
                                                ...
                                                <div class="mt-30"><a class="btn btn-brand-2" href="shop-grid.html">Shop
                                                        now</a><a class="btn btn-link" href="shop-grid.html">Learn more</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <ul class="nav nav-tabs" role="tablist">
                                <li>
                                    <a class="active" href="#tab-all" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-all" aria-selected="true">All</a>
                                </li>
                                <li>
                                    <a href="#tab-bestseller" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-bestseller" aria-selected="true">Best seller</a>
                                </li>
                                <li>
                                    <a href="#tab-mostviewed" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-mostviewed" aria-selected="true">Most viewed</a>
                                </li>
                                <li>
                                    <a href="#tab-topbrands" data-bs-toggle="tab" role="tab"
                                        aria-controls="tab-topbrands" aria-selected="true">Top Brands</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="list-products-5">
                            ...
                            @forelse ($products as $product)
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner h-100">
                                        <div class="tools">
                                            <a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"
                                                data-bs-placement="left"></a>
                                            <a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html"
                                        ...
                                        <div class="info-right">
                                            ...
                                            <div class="price-info">
                                                @if ($product->discounted_price > 0)
                                                    <strong
                                                        class="font-lg-bold color-brand-3 price-main">${{ $product->discounted_price }}</strong>
                                                    <span class="color-gray-500 price-line">${{ $product->price }}</span>
                                                @else
                                                    <strong
                                                        class="font-lg-bold color-brand-3 price-main">${{ $product->price }}</strong>
                                                    {{-- <span class="color-gray-500 price-line">${{ $product->discounted_price }}</span> --}}
                                                @endif
                                            </div>
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            ...
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.html">Philips
                                            H4205 On-Ear Wireless Headphones
                                            with 32mm</a>
                                        <div class="rating"><img
                                                src="{{ asset('user-assets') }}/imgs/template/icons/star.svg"
                                                alt="Ecom"><img
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product.html">Razer
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card-grid-style-3">
                                    <div class="card-grid-inner">
                                        ...
                                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                                class="color-brand-3 font-sm-bold" href="shop-single-product.html">ASUS
                    ...
                    <div class="swiper-container swiper-group-4">
                        <div class="swiper-wrapper pt-5">
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2.html"></a><img
                                            src="{{ asset('user-assets') }}/imgs/page/blog/blog-1.jpg" alt="Ecom">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single.html"></a><img
                                            src="{{ asset('user-assets') }}/imgs/page/blog/blog-2.jpg" alt="Ecom">
                                    </div><a class="tag-dot font-xs" href="blog-list.html">Technology</a><a
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-3.html"></a><img
                                            src="{{ asset('user-assets') }}/imgs/page/blog/blog-3.jpg" alt="Ecom">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2.html"></a><img
                                            src="{{ asset('user-assets') }}/imgs/page/blog/blog-4.jpg" alt="Ecom">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-style-1">
                                    <div class="image-box"><a href="blog-single-2.html"></a><img
                                            src="{{ asset('user-assets') }}/imgs/page/blog/blog-5.jpg" alt="Ecom">
        ...
        <section class="section-box mt-90 mb-50">
            <div class="container">
                <ul class="list-col-5">
                    <li>
                        <div class="item-list">
                            <div class="icon-left"><img src="{{ asset('user-assets') }}/imgs/template/delivery.svg"
                                    alt="Ecom">
                            </div>
                            <div class="info-right">
