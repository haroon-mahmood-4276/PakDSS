...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'admin.tags.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Tag</h2>
        {{ Breadcrumbs::render('admin.tags.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('admin.tags.store') }}" method="POST" enctype="multipart/form-data">

        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">

                @csrf
                {{ view('admin.tags.form-fields') }}
