...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'admin.homepage.sliders.create') }}
@endsection

@section('page-title', 'Create Sliders')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Sliders</h2>
        {{ Breadcrumbs::render('admin.homepage.sliders.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('admin.homepage.sliders.store') }}" method="POST"
