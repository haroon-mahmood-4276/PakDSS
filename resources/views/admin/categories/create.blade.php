...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'admin.categories.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Category</h2>
    ...
    <form class="form form-vertical" action="{{ route('admin.categories.store') }}" method="POST"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                {{ view('admin.categories.form-fields', ['brands' => $brands, 'categories' => $categories]) }}
